...
<div class="container" style="margin-top:20px">
    ...
    <form action="index.php?page=edit_pendidikan&NIS=<?php echo $NIS; ?>" method="post">
        ...
        <div class="item form-group">
            <label class="col-form-label col-md-3 col-sm-3 label-align">PAGI</label>
            <div class="col-md-6 col-sm-6">
                <input type="text" name="PAGI" class="form-control" value="<?php echo $data['PAGI']; ?>" readonly required>
            </div>
            <div class="item form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align">Skor</label>
                <div class="col-md-6 col-sm-6">
                    <input type="text" name="SKOR_P" class="form-control" value="<?php echo $data['SKOR_P']; ?>" required>
                </div>
            </div>
        </div>
        <div class="item form-group">
            <label class="col-form-label col-md-3 col-sm-3 label-align">SORE</label>
            <div class="col-md-6 col-sm-6">
                <input type="text" name="SORE" class="form-control" value="<?php echo $data['SORE']; ?>" readonly required>
            </div>
            <div class="item form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align">Skor</label>
                <div class="col-md-6 col-sm-6">
                    <input type="text" name="SKOR_S" class="form-control" value="<?php echo $data['SKOR_S']; ?>" required>
                </div>
            </div>
        </div>
        <div class="item form-group">
