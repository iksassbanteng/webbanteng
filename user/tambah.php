...
if (isset($_POST['submit'])) {
	...
	if (move_uploaded_file($tmp, $path)) {
		...
		if (mysqli_num_rows($cek) == 0) {
			$sql = mysqli_query($koneksi, "INSERT INTO santri(ID, NIK, NAMA, ASRAMA, USIA ,DUSUN, RT, RW, DESA, KECAMATAN, WALI, TELEPON , FOTO) VALUES('$id', '$nik', '$Nama_santri', '$Asrama', '$Usia' ,'$Dusun', '$RT', '$RW', '$Desa', '$Kecamatan', '$Wali', '$Telepon', '$fotobaru' )") or die(mysqli_error($koneksi));
...
<form action="index.php?page=tambah_santri" method="post" enctype="multipart/form-data">
	...
	<div class="item form-group">
		<div class="col-md-6 col-sm-6 offset-md-3">
			<input type="submit" name="kembali" action="index.php?page=tambah_santri" class="btn btn-secondary" value="Kembali">
		</div>
	</div>
</form>
</div>